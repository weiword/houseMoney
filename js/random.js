...
(function () {
  ...
  var CACHE_MIN  = 10; // how long to cache the folder listing (minutes)
  ...
  async function randomFont() {
    try {
      ...
      document.documentElement.style.setProperty('--rand-font', '"SiteRandomFont", "Newsreader", Georgia, serif');
    } catch (e) {
